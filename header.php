...
?>
	...
	<link href = "fonts/FSLucasPro-Light.ttf" rel = "stylesheet" type = "text/css" />
...
<body>   
	...
	<div class="" style="       padding-top: 10px;   background-image: linear-gradient(90deg, rgb(42 53 133) 0%, rgb(21 172 190) 100%);
">
		<div class="row">
			<div class="col-md-4">
				 	<div class="footer-social-profile">
                               <center> <ul>
                                    <li><a href="tel:<?php echo $phone; ?>"><i class="fa fa-phone"></i></a></li>
                                    <li><a href="https://api.whatsapp.com/send/?phone=<?php echo $wa?>&text&app_absent=0" target="_blank"><i class="fa fa-whatsapp"></i></a></li>
                                </ul>
								</center>
                            </div>
			</div>
			...
			<div class="col-md-4 col-md-offset-4">
				  <h3 style="color:white !important;"> <a href="tel:<?php echo $phone; ?>" style="    color: #ffffff;background-color:#ffffff00;padding:5px;border-radius:15px;font-family:Farro;">  Click to call: +971 4 243 4677  </a> </h3>
			</div>
		</div>
	</div>
    <!-- Start Navigation -->
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                    ...
                    <li class="dropdown megamenu-fw hidden">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Ser</a>
                    ...
                    <li> <a href="tel:<?php echo $phone; ?>"> Contact us</a></li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </div>   
